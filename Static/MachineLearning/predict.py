...
def check_model_1(word):
    model=load_model("./MachineLearning/models/model2.h5")
    crs=[]
    d={}
...
def check_model_2(word):
    model=load_model("./MachineLearning/models/model3.h5")
    crs=[]
    d={}
    d=verify_enc.initializare(d)
    test = []
...
def check_model_4(word):
    model=load_model("./MachineLearning/models/model_ads.h5")
    crs=[]
    d={}
    d=verify_enc.initializare_ads(d)
    test = []
    encoding = verify_enc.verify_encoding(word,d)
    if (encoding == None):
        encoding = 0
